...
export const VENDOR_DOCUMENT_TYPE_TITLES: Record<VendorDocumentType, string> = {
  ACORD_25_COI: "Certificado de seguro (ACORD 25)",
  INSURANCE_POLICY_DEC_PAGE: "Página de declaraciones de la póliza de seguro",
  UMBRELLA_POLICY: "Póliza umbrella / de exceso de responsabilidad",
  W9: "Formulario W-9 del IRS",
  W8_BEN_E: "Formulario W-8BEN-E del IRS",
  BUSINESS_LICENSE: "Licencia comercial",
  DIVERSITY_CERT: "Certificación de diversidad",
  EMR_LETTER: "Carta de EMR (tasa de modificación por experiencia)",
  OSHA_300A: "Resumen del Formulario 300A de OSHA",
  SOC2_REPORT: "Informe SOC 2",
  ISO_27001_CERT: "Certificado ISO 27001",
  CYBER_POLICY: "Póliza de responsabilidad cibernética",
  BANK_LETTER: "Carta de verificación bancaria",
  VOID_CHECK: "Cheque anulado",
  MSA_SIGNED: "Contrato marco de servicios firmado",
  NDA_SIGNED: "Acuerdo de confidencialidad firmado",
